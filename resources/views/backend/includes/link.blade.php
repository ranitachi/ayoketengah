...
<script type="text/javascript" src="{{asset('back/assets/js/plugins/tables/datatables/datatables.min.js')}}"></script>
...
<script type="text/javascript" src="{{asset('back/assets/js/pages/dashboard.js')}}"></script>
<script type="text/javascript" src="{{asset('back/assets/js/plugins/ui/ripple.min.js')}}"></script>
	<!-- /theme JS files -->