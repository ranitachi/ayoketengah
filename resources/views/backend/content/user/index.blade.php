    ...
    <div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-newspaper position-left"></i> <span class="text-semibold">Data</span> - User</h4>
            </div>
            <div class="heading-elements">
				<a href="{{route('admin-user.form',-1)}}" class="btn btn-sm ungu-bg text-white"><i class="icon-googleplus5"></i> &nbsp;Tambah User</a>
			</div>
		</div>
...
@section('script')
    ...
    <script>
        ...
        function loaddata()
        {
            var url_ajax=url+'/api/json-user';
        ...
        function hapus(id)
        {
            ...
            $('#okhapus').one('click',function(){
                location.href=url+'/admin-user-hapus/'+id
            });
        }
    </script>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<h6 class="text-semibold">Apakah Anda Yakin ingin menghapus Data User ini ?</h6>
				</div>
