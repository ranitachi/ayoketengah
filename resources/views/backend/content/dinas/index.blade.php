    ...
    <div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-newspaper position-left"></i> <span class="text-semibold">Data</span> - Dinas</h4>
            </div>
            <div class="heading-elements">
				<a href="{{route('admin-dinas.form',-1)}}" class="btn btn-sm ungu-bg text-white"><i class="icon-googleplus5"></i> &nbsp;Tambah Dinas</a>
			</div>
		</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-flat">
                    <div class="panel-heading">
							<h5 class="panel-title">Data Dinas</h5>
							<div class="heading-elements">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                @endif
                                @if ($dinas->count()!=0)
                                    <table class="table datatable-slider table-bordered table-hovered table-striped">
                                        <thead>
                                            <tr class="ungu-bg text-white">
                                                <th>No</th>
                                                <th>Nama Dinas</th>
                                                <th>Nama Pimpinan</th>
                                                <th>Web / Email / Telp</th>
                                                <th>#</th>
                                            </tr>
                                        </thead>
                                    </table>
...
@section('script')
    ...
    <script>
        ...
        function loaddata()
        {
            var url_ajax=url+'/api/json-dinas';
        ...
        function hapus(id)
        {
            ...
            $('#okhapus').one('click',function(){
                location.href=url+'/admin-dinas-hapus/'+id
            });
        }
    </script>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<h6 class="text-semibold">Apakah Anda Yakin ingin menghapus Data Dinas ini ?</h6>
				</div>
