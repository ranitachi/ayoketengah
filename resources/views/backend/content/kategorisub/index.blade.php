    ...
    <div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-newspaper position-left"></i> <span class="text-semibold">Data</span> - Sub Kategori</h4>
            </div>
            <div class="heading-elements">
				<a href="{{route('admin-sub-kategori.form',[-1,-1])}}" class="btn btn-sm ungu-bg text-white"><i class="icon-googleplus5"></i> &nbsp;Tambah Sub Kategori</a>
			</div>
		</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-flat">
                    <div class="panel-heading">
							<h5 class="panel-title">Data Sub Kategori</h5>
							<div class="heading-elements">
                            ...
                            <div class="col-lg-12">
                                ...
                                @else
                                    <div class="text-center">
                                        <h3>Data Sub Kategori Masih Kosong</h3>
                                        <br>
                                        <a href="{{route('admin-sub-kategori.form',[-1,-1])}}" class="btn btn-sm ungu-bg text-white"><i class="icon-googleplus5"></i> &nbsp;Tambah Sub Kategori</a>
                                    </div>
                                @endif
...
@section('script')
    ...
    <script>
        ...
        function loaddata()
        {
            var url_ajax=url+'/api/json-sub-kategori';
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<h6 class="text-semibold">Apakah Anda Yakin ingin menghapus Data Sub Kategori ini ?</h6>
				</div>
