    ...
    <div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-newspaper position-left"></i> <span class="text-semibold">Data</span> - Slider</h4>
            </div>
            <div class="heading-elements">
				<a href="{{route('admin-slider.form',-1)}}" class="btn btn-sm ungu-bg text-white"><i class="icon-googleplus5"></i> &nbsp;Tambah Slider</a>
			</div>
		</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-flat">
                    <div class="panel-heading">
							<h5 class="panel-title">Data Slider</h5>
							<div class="heading-elements">
                            ...
                            <div class="col-lg-12">
                                ...
                                @else
                                    <div class="text-center">
                                        <h3>Data Slider Masih Kosong</h3>
                                        <br>
                                        <a href="{{route('admin-slider.form',-1)}}" class="btn btn-sm ungu-bg text-white"><i class="icon-googleplus5"></i> &nbsp;Tambah Slider</a>
                                    </div>
                                @endif
...
@section('script')
    ...
    <script>
        ...
        function loaddata()
        {
            var url_ajax=url+'/api/json-slider';
        ...
        function hapus(id)
        {
            ...
            $('#okhapus').one('click',function(){
                location.href=url+'/admin-slider-hapus/'+id
            });
        }
    </script>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<h6 class="text-semibold">Apakah Anda Yakin ingin menghapus Data Slider ini ?</h6>
				</div>
